...
面向上海高中学习场景的学习辅助网站。课程按“学期 -> 学科 -> 教材章节 -> 课节 -> 知识点”组织；尚未逐章录入的课程沿用教材主题单元目录。网站覆盖高一上至高三下六个学期、十个学科和 3,117 个可检索知识点。教材学习、知识检索和专题复习是主体，互动实验与动态图解是理解知识的辅助呈现方式。
...
- 物理深度学习：六学期 516 个知识点按教材或复习章节组织，使用 19 个物理课文族讲清模型、推导、定量例题、实验与适用边界
- 化学深度学习：六学期 534 个知识点使用 28 个化学课文族贯通宏观现象、微观粒子、化学符号、守恒计算和实验评价；专门覆盖分子构型、晶胞、波谱、滴定、分离、制气、材料可持续与综合推理
- 科学交互图解：物理接入 19 类、化学接入 21 类，共 40 类主题图解。在受力、运动、能量、波、电磁和结构反应图解之外，进一步补齐变压器、传感器、气体 p-V 过程、核衰变、电解与腐蚀、滴定曲线、气体装置路线和有机反应类型；可动态表达的过程提供播放、暂停、步骤推进或参数控制，并支持减少动态效果设置
...
端到端测试覆盖六学期数学、物理和化学教材结构、逐知识点讲解深度、知识族与图解族路由、科学关系不变量、关键图解交互、全部通用演示、跨学期搜索、1440/390/320px 布局，以及浅色和深色模式的 WCAG 2 A/AA 检查。40 类科学图解均有代表主题回归；新增图解会逐个切换全部模式和滑块极值，并直接测量 SVG 图元边界，动画还会在运行中切换减少动态效果，验证立即停止。
