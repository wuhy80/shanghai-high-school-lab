...
- 化学深度学习：六学期 534 个知识点使用 18 个化学课文族贯通宏观现象、微观粒子、化学符号、守恒计算和实验评价
- 科学交互图解：物理、化学全部知识点接入 15 类主题图解；运动、电路、波和有效碰撞等过程提供播放、暂停与参数控制，并支持减少动态效果设置
...
端到端测试覆盖六学期数学、物理和化学教材结构、逐知识点讲解深度、知识族路由、关键图解交互、全部通用演示、跨学期搜索、1440/390/320px 布局，以及浅色和深色模式的 WCAG 2 A/AA 检查。990 个数学知识点和 1,050 个物理、化学知识点另经过三种视口逐项打开、控件极值、SVG 有效性与页面溢出验收。
